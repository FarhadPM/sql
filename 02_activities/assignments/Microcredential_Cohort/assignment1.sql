...
SELECT vendor_id, COUNT(vendor_id) AS num_booth_rented
...
VALUES (10, 'Italian Pasta', 'Prepared Foods', 'Alfredo', 'Jiovani');
...
SELECT c.*, SUM(quantity * cost_to_customer_per_qty) AS spent_april_2022
